...
$this->end_controls_section();
	...
	protected function render() {
		require AWESOME_ADDONS_PATH . '/modules/glow-text-effects/template/view.php';
	}

	// protected function _content_template() {
	// 	require AWESOME_ADDONS_PATH . '/modules/glow-text-effects/template/content-template.php';
	// }
